    ...
    public partial class Startup
    {
        ...
        public void CreateDefaultRolesAndUser()
        {
            ...
            if (!roleManager.RoleExists("Magic"))
            {
                ...
                user.UserName = "mag@mag.net";
                user.UserType = "Magic";
                user.nikname = "Magic";
                user.LockoutEnabled = true;

                user.Email = "mag@mag.net";
                var Check = userManager.Create(user, "M.kh8888");
                if (Check.Succeeded)
                {
        ...
        public void CreateDefaultRolesAndUserentery()
        {
            ...
            if (!roleManager.RoleExists("User"))
            {
                ...
                roleManager.Create(role);
                ApplicationUser user = new ApplicationUser();
                user.UserName = "user@mag.net";
                user.UserType = "User";
                user.nikname = "مدخل بيانات";
                user.LockoutEnabled = true;

                user.Email = "user@mag.net";
                var Check = userManager.Create(user, "M.kh8888");
                if (Check.Succeeded)
                {
        ...
        public void CreateDefaultRolesAndUsers()
        {
            ...
            {                                                                       
                ...
                roleManager.Create(role);
                ApplicationUser user = new ApplicationUser();
                user.UserName = "admin@mag.net";
                user.UserType = "Admins";
                user.nikname = "مسؤوول";
                user.LockoutEnabled = true;    
                user.Email = "admin@mag.net";
                var Check = userManager.Create(user, "M.kh888");
                if (Check.Succeeded)
                {
